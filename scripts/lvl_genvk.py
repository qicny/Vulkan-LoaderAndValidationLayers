...
from layer_framework_generator import LayerFrameworkGeneratorOptions, LayerFrameworkOutputGenerator
...
def makeGenOpts(extensions = [], removeExtensions = [], protect = True, directory = '.'):
    ...
    # Options for Lightweight Layer Framework header
    genOpts['layer_framework.h'] = [
          LayerFrameworkOutputGenerator,
          LayerFrameworkGeneratorOptions(
            filename          = 'layer_framework.h',
            directory         = directory,
            apiname           = 'vulkan',
            profile           = None,
            versions          = allVersions,
            ...
            apientryp         = 'VKAPI_PTR *',
            alignFuncParam    = 48,
            helper_file_type  = 'layer_framework_header')
        ]

    # Options for Lightweight Layer Framework source file
    genOpts['layer_framework.cpp'] = [
          LayerFrameworkOutputGenerator,
          LayerFrameworkGeneratorOptions(
            filename          = 'layer_framework.cpp',
            directory         = directory,
            apiname           = 'vulkan',
            profile           = None,
            versions          = allVersions,
            ...
            apientryp         = 'VKAPI_PTR *',
            alignFuncParam    = 48,
            helper_file_type  = 'layer_framework_source')
        ]
